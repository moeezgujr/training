...
export function NoteTaking({ contentId, timestamp }: NoteTakingProps) {
  ...
  // Fetch notes for this content
   ...
   queryFn: async () => {
      const res = await apiRequest('GET', `/api/notes?contentId=${contentId}`);
      const data = await res.json();
      return data.map((n: any) => ({ ...n, text: n.text || n.content || '' }));
    },
 ...
 const createMutation = useMutation({
    ...
    onError: () => {
      toast({ title: "Error", description: "Failed to save the note. Please try again.", variant: "destructive" });
    },
  });
 ...
 const updateMutation = useMutation({
    ...
    onError: () => {
      toast({ title: "Error", description: "Failed to update the note. Please try again.", variant: "destructive" });
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: () => {
      toast({ title: "Error", description: "Failed to delete the note. Please try again.", variant: "destructive" });
    },
  });
