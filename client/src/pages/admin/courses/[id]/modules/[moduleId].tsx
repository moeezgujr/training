  ...
  mutationFn: async (data: QuestionFormData) => {
    const url = editingQuestion 
      ...
      : `/api/admin/quizzes/${managingQuizId}/questions`;
       ...
       const payload = {
      ...data,
      correctAnswer: data.correctAnswer,  // ← FIXED: Store as plain string
...
if (typeof question.correctAnswer === 'string') {
  correctAnswerValue = question.correctAnswer;  // ✓ Use directly
} else if (Array.isArray(question.correctAnswer)) {
  correctAnswerValue = question.correctAnswer[0] || "";
} else {
  correctAnswerValue = String(question.correctAnswer || "");
};
