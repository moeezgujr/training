...
export default function AdminLogin() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    setIsLoading(true);
    console.log('Frontend login attempt:', { email: data.email, hasPassword: !!data.password });
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast({
          title: 'Login Failed',
          description: result.message || 'Invalid credentials or insufficient privileges',
          variant: 'destructive',
        });
      }
    } catch (error) {
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <p className="text-sm text-blue-800">
              <strong>Note:</strong> Only users with admin role can access the admin dashboard.
